  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SizedBox(
        ...
        child: meetingRequests.isNotEmpty ? ListView.builder(
                                      ...
                                      if (date != null && time != null) {
                                        ...
                                        homeBloc.add(
                                            MeetingRequestTickButtonClickedEvent(
                                                meetingId: meetingRequests[
                                                        index]
                                                    .meetingId,
                                                teacherId: meetingRequests[
                                                        index]
                                                    .teacherId,
                                                studentName:
                                                    meetingRequests[
        ...
        : Center(child: Text("No Meeting Requests", style: GoogleFonts.arvo(
              textStyle: const TextStyle(
